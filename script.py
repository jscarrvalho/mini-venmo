...
class User:
    ...
    def add_friend(self, new_friend):
        self.append(new_friend)
        self.add_to_feed('{} added {} as friend.'.format(self.username, targe.username))
    ...
    def pay(self, target, amount, note):
        ...
        self.add_to_feed('{} paid {} ${::2f} for {}'.format(self.username, targe.username, amount, note))
    ...
    def pay_with_balance(self, target, amount, note):
        if self.balance >= amount:
            ...
            raise PaymentException('Not enougth money to pay.')
...
class MiniVenmo:
    def create_user(self, username, balance, credit_card_number):
        try:
            ...
            if user._is_valid_credit_card(credit_card_number):
